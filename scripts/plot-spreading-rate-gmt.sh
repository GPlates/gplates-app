...
# plot present-day spreading rate with GMT.
# you need at least the Seton_etal_2020_PresentDaySR6m_GeeK2007.nc and fullrategrid.cpt to run this script.
...
# --- files ---
grid_file=./Seton_etal_2020_PresentDaySR6m_GeeK2007.nc
cpt_file=./fullrategrid.cpt
file_basename=Seton_etal_2020_PresentDaySR6m_GeeK2007
